...
const baseCategories: Omit<CategoryInfo, "productCount">[] = [
  {
    id: "sunglasses",
    name: "Sunglasses",
    description: "High-contrast eyewear, polished silhouettes, and seasonal edit drops.",
  ...
  },
  {
    id: "women-clothes",
    name: "Designer Women",
    description: "Tailored separates, elevated knitwear, and statement evening layers.",
...
const categoryCounts = products.reduce<Record<CategorySlug, number>>(
  (counts, product) => {
